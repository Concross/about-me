...
// Checks if users answer matches a correct yes answer
function checkYesCorrect (answer){
  for (var i = 0; i < possibleYesAnswers.length; i++){
    if (answer === possibleYesAnswers[i]){
      return true;
    };
  };
  return false;
...
// Checks if users answer matches a correct no answer
function checkNoCorrect (answer){
  for (var i = 0; i < possibleNoAnswers.length; i++){
    if (answer === possibleNoAnswers[i]){
      return true;
    };
  };
  return false;
